...
## Подключаем AI к разным инструментам

> **Цель блока:** Научиться подключать AI инструменты к внешним данным и сервисам через единый стандарт MCP

**Что ты узнаешь:**
- Зачем нужен MCP и какую проблему он решает
- Как работает архитектура MCP
- Какие популярные MCP серверы существуют
- Как настроить MCP в Claude Code и Cursor
...
**ЧАСТЬ 3: ПОПУЛЯРНЫЕ MCP СЕРВЕРЫ**
**ЧАСТЬ 4: ПРАКТИКА — НАСТРОЙКА MCP**
**ЧАСТЬ 5: MCP VS SKILLS**
**ЧАСТЬ 6: БЕЗОПАСНОСТЬ MCP**
**ЧАСТЬ 7: СОЗДАНИЕ СВОЕГО MCP СЕРВЕРА**
**ЧАСТЬ 8: БУДУЩЕЕ MCP**
